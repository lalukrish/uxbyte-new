...
const MaritimeCarousel = () => {
  ...
  useEffect(() => {
    ...
    script1.onload = () => {
      ...
      script2.onload = () => {
        ...
        // Set initial positions - all images start far back
        imageRefs.current.forEach((el, index) => {
          if (!el) return;
          const img = images[index];
        ...
        // Create flowing timeline - images move FORWARD through screen
        const tl = gsap.timeline({
          scrollTrigger: {
            trigger: containerRef.current,
            start: "top top",
  ...
  return (
    <div className="w-full bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
      ...
      >
        {/* CASES text background */}
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <h1 className="text-[20vw] font-black text-white/5 select-none tracking-tighter">
            CASES
          </h1>
        </div>
        ...
        >
          {images.map((img, index) => (
            ...
            >
              ...
              <div className="relative w-full h-full group">
                {/* Glow effect */}
                <div className="absolute -inset-1 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-xl blur-xl opacity-75" />
        ...
        {/* Decorative elements */}
        <div className="absolute top-1/4 left-0 w-px h-32 bg-gradient-to-b from-transparent via-cyan-500/30 to-transparent" />
        <div className="absolute top-1/3 right-0 w-px h-40 bg-gradient-to-b from-transparent via-blue-500/30 to-transparent" />
      </div>

      {/* End content */}
      <div className="relative w-full min-h-screen bg-slate-900 flex items-center justify-center p-8">
        <div className="max-w-4xl text-center">
          ...
          <button className="px-8 py-4 bg-cyan-500 hover:bg-cyan-600 text-white font-semibold rounded-lg transition-colors duration-300 shadow-lg hover:shadow-cyan-500/50">
            Explore All Cases
          </button>
        </div>
      </div>
