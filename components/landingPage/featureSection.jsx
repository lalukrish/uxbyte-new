...
export default function BusinessFeatureSection() {
  ...
  return (
    <section className="w-full min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
      <div className="max-w-7xl w-full mx-auto">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12">
          {/* LEFT SIDE */}
          <div className="w-full lg:w-1/2 max-w-xl">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold mb-6 text-gray-800 leading-snug text-center lg:text-left">
              ...
              {features.map((item, index) => (
                <div key={index} className="border-b last:border-none">
                  <button
                    ...
                    className={`w-full flex items-center justify-between py-4 text-base sm:text-lg font-medium transition-colors ${
                      openIndex === index
                        ? "text-blue-600"
          ...
          <div className="w-full lg:w-2/3 flex items-center justify-center mt-20">
            <div className="bg-white rounded-2xl overflow-hidden w-full max-w-xl transform hover:scale-[1.02] transition duration-300">
              ...
              <div className="p-5 sm:p-6">
                ...
                {/* <div className="bg-blue-50 p-4 rounded-xl text-center">
                  ...
                  <button className="px-4 py-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 transition text-sm sm:text-base">
                    Subscribe
                  </button>
                </div> */}
              </div>
