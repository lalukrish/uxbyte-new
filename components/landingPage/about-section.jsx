...
const AboutSection = () => {
  ...
  return (
    <div className="white-section">
      <section className="white-section  min-h-screen grid grid-cols-1  items-center xl:flex overflow-x-hidden">
        <div className="white-section px-3 sm:px-10 xl:pl-24 2xl:pl-48 w-full xl:w-3/5 pt-12">
          <EncryptedText
...
"
          ...
          <Paragraph className="mt-5">
            ...
            solutions across development, cloud, design, marketing, and
            branding. UXByte combines technology, creativity, and strategy to
            help businesses grow, scale, and thrive in a rapidly evolving
            digital landscape. Our focus is on building reliable, scalable, and
            impactful solutions that deliver real results.
          </Paragraph>
        </div>
